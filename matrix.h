...
double** summation(double** matrix, double** matrix2, int matrix_size);

//Функция возведения матрицы в степень
double** matrix_power(double** matrix, double matrix_size, int num);

//Единичная матрица
void identity_matrix_create(double** identity_matrix, double matrix_size);

//Функция очистки памяти матриц
void clean_matrix(double** matrix, int matrix_size);

//Функция умножения матриц
double** matrix_multiply(double** matrix, double** matrix2, double matrix_size);
